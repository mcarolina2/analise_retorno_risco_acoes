...
Corr01 <- correlationTest(Correl$lwsa3, Correl$brfs3, Correl$elet6, Correl$itsa4, Correl$rent3, method = "pearson")
print(Corr01)
...
plot(Correl$rent3, Correl$brfs3, Correl$lwsa3, Correl$elet6, Correl$itsa4,
