...
for (ticker in acoes){
  ...
  # Calcular média móvel suavizada
  precos_suavizados <- SMA(precos, n = 3)
  ...
  # Abrir gráfico
  plot(ativo, main = paste("Análise de Dow -", toupper(ticker)), col = "black")
  
  # Linha da média móvel
  lines(datas, precos_suavizados, col = "darkgreen", lwd = 2, lty = 1)
  ...
  # Legenda
  legend("topleft", legend = c("Fundos", "Topos", "Tendência de Alta", "Tendência de Baixa", "Média Móvel (SMA 3)"),
         col = c("blue", "red", "blue", "red", "darkgreen"),
...
-   
    ...
    -   No ativo BRFS3: nesse ativo podemos verificar que a média acompanhou o preço do ativo ,confirmando a nossa hipótese da teoria de dow deu que vem uma tendência de alta
